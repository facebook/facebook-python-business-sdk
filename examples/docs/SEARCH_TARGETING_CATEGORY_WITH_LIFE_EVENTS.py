...
# _DOC open [SEARCH_TARGETING_CATEGORY_WITH_LIFE_EVENTS]
from facebookads.objects import TargetingSearch
params = {
    'type': TargetingSearch.TargetingSearchTypes.targeting_category,
    'class': TargetingSearch.DemographicSearchClasses.home_ownership,
}

resp = TargetingSearch.search(params=params)
print(resp)
# _DOC close [SEARCH_TARGETING_CATEGORY_WITH_LIFE_EVENTS]
