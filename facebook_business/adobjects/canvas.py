...
class Canvas(
    ...
    def create_duplicate_canva(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
        }
        enums = {
        }
    ...
    def create_preview_notification(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
            'user_ids': 'list<int>',
        }
        enums = {
