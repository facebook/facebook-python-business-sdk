...
class AdCampaignGroupActivity(
    ...
    def _get_field_enum_info(cls):
        ...
        field_enum_info['ChangedAll'] = AdCampaignGroupActivity.ChangedAll.__dict__.values()
        field_enum_info['ChangedAny'] = AdCampaignGroupActivity.ChangedAny.__dict__.values()
