...
class ProductCatalogLocalizedItemsBatchPost(
    AbstractObject,
):

    def __init__(self, api=None):
        super(ProductCatalogLocalizedItemsBatchPost, self).__init__()
        self._isProductCatalogLocalizedItemsBatchPost = True
        self._api = api
    ...
    def _get_field_enum_info(cls):
        field_enum_info = {}
        field_enum_info['ItemSubType'] = ProductCatalogLocalizedItemsBatchPost.ItemSubType.__dict__.values()
