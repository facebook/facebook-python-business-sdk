...
class ProductCatalog(
    ...
    def get_auto_markets(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.automarket import AutoMarket
        param_types = {
        }
        enums = {
        }
        request = FacebookRequest(
            ...
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=AutoMarket,
            api_type='EDGE',
            response_parser=ObjectParser(target_class=AutoMarket, api=self._api),
        )
        request.add_params(params)
        request.add_fields(fields)
    ...
    def get_autos(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.auto import Auto
        param_types = {
        }
        enums = {
        }
        request = FacebookRequest(
            ...
            target_class=Auto,
            api_type='EDGE',
            response_parser=ObjectParser(target_class=Auto, api=self._api),
        )
        request.add_params(params)
        request.add_fields(fields)
    ...
    def get_catalog_segment_merchant_tos(self, fields=None, params=None, batch=None, pending=False):
        ...
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/catalog_segment_merchant_tos',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
    ...
    def get_catalog_segments(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
        }
        enums = {
        }
    ...
    def get_dpa_ad_accounts(self, fields=None, params=None, batch=None, pending=False):
    ...
    def get_dpa_eligible_ad_accounts(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.adaccount import AdAccount
        param_types = {
            'limit': 'unsigned int',
        }
        ...
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/dpa_eligible_ad_accounts',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=AdAccount,
            api_type='EDGE',
    ...
    def get_example_feed(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.productcatalogexamplefeed import ProductCatalogExampleFeed
        param_types = {
            'size': 'unsigned int',
        ...
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/example_feed',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=ProductCatalogExampleFeed,
            api_type='EDGE',
            response_parser=ObjectParser(target_class=ProductCatalogExampleFeed, api=self._api),
        )
        request.add_params(params)
        request.add_fields(fields)
    ...
    def get_facets(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.productcatalogfacets import ProductCatalogFacets
        param_types = {
            'filter': 'Object',
            'facets': 'Object',
        }
        ...
        request = FacebookRequest(
            ...
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=ProductCatalogFacets,
            api_type='EDGE',
            response_parser=ObjectParser(target_class=ProductCatalogFacets, api=self._api),
        )
        request.add_params(params)
        request.add_fields(fields)
    ...
    def get_home_service_providers(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.homeserviceprovider import HomeServiceProvider
        param_types = {
            'bulk_pagination': 'bool',
            'filter': 'Object',
        }
        ...
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/home_service_providers',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=HomeServiceProvider,
            api_type='EDGE',
            response_parser=ObjectParser(target_class=HomeServiceProvider, api=self._api),
        )
        request.add_params(params)
        request.add_fields(fields)
    ...
    def get_merchant_reports(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.merchantreport import MerchantReport
        param_types = {
            'time_range': 'Object',
        }
        enums = {
        ...
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/merchant_reports',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=MerchantReport,
            api_type='EDGE',
            response_parser=ObjectParser(target_class=MerchantReport, api=self._api),
        )
        request.add_params(params)
        request.add_fields(fields)
    ...
    def get_quality_issue_samples(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.productitem import ProductItem
        param_types = {
        }
        enums = {
        ...
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/quality_issue_samples',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=ProductItem,
            api_type='EDGE',
    ...
    def get_risky_products(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.productitem import ProductItem
        param_types = {
            'order_by': 'order_by_enum',
        }
        enums = {
            'order_by_enum': ProductItem.OrderBy.__dict__.values(),
        }
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/risky_products',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=ProductItem,
            api_type='EDGE',
    ...
    def get_smart_pixel_settings(self, fields=None, params=None, batch=None, pending=False):
        ...
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/smart_pixel_settings',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=CatalogSmartPixelSettings,
            api_type='EDGE',
            response_parser=ObjectParser(target_class=CatalogSmartPixelSettings, api=self._api),
        )
        request.add_params(params)
        request.add_fields(fields)
    ...
    def get_smart_pixel_stats(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.smartpixelinsights import SmartPixelInsights
        param_types = {
        }
        enums = {
        }
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/smart_pixel_stats',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=SmartPixelInsights,
            api_type='EDGE',
            response_parser=ObjectParser(target_class=SmartPixelInsights, api=self._api),
        )
        request.add_params(params)
        request.add_fields(fields)
    ...
    def get_suggested_product_sets(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.suggestedproductset import SuggestedProductSet
        param_types = {
        }
        enums = {
        }
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/suggested_product_sets',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=SuggestedProductSet,
            api_type='EDGE',
            response_parser=ObjectParser(target_class=SuggestedProductSet, api=self._api),
        )
        request.add_params(params)
        request.add_fields(fields)
    ...
    def _get_field_enum_info(cls):
        ...
        field_enum_info['OwnerTypes'] = ProductCatalog.OwnerTypes.__dict__.values()
