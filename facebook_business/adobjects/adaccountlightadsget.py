...
class AdAccountLightAdsGet(
    AbstractObject,
):

    def __init__(self, api=None):
        super(AdAccountLightAdsGet, self).__init__()
        self._isAdAccountLightAdsGet = True
        self._api = api
    ...
    def _get_field_enum_info(cls):
        field_enum_info = {}
        field_enum_info['DatePreset'] = AdAccountLightAdsGet.DatePreset.__dict__.values()
