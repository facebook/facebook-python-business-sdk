...
class BlindPig(
    ...
    def get_debtor_pigs(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
        }
        enums = {
        }
    ...
    def get_dynamically_named_assoc_edge(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
        }
        enums = {
        }
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/dynamically_named_assoc_edge',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=BlindPig,
            api_type='EDGE',
