...
class TarotDigest(
    ...
    def __init__(self, fbid=None, parent_id=None, api=None):
        self._isTarotDigest = True
        super(TarotDigest, self).__init__(fbid, parent_id, api)
    ...
    def _get_field_enum_info(cls):
        field_enum_info = {}
        field_enum_info['PublishStatuses'] = TarotDigest.PublishStatuses.__dict__.values()
