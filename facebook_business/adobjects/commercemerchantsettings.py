...
class CommerceMerchantSettings(
    ...
    def get_commerce_merchant_applications(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
        }
        enums = {
        }
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/commerce_merchant_applications',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
    ...
    def get_commerce_offers(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
        }
        enums = {
        }
    ...
    def get_orders(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
            'offset': 'unsigned int',
            'limit': 'unsigned int',
    ...
    def get_product_item_metrics(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
            'offset': 'unsigned int',
            'size': 'unsigned int',
            'start_time_created': 'datetime',
    ...
    def get_setup_status(self, fields=None, params=None, batch=None, pending=False):
