...
class BusinessResourceGroup(
    ...
    def get_contained_ad_accounts(self, fields=None, params=None, batch=None, pending=False):
    ...
    def get_contained_offline_conversion_data_sets(self, fields=None, params=None, batch=None, pending=False):
    ...
    def get_contained_pages(self, fields=None, params=None, batch=None, pending=False):
    ...
    def get_contained_pixels(self, fields=None, params=None, batch=None, pending=False):
