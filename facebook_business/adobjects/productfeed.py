...
class ProductFeed(
    ...
    def get_rule_preview_samples(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.productfeedrulepreviewsample import ProductFeedRulePreviewSample
        param_types = {
            'attribute': 'string',
            'params': 'map',
        ...
        enums = {
            'rule_type_enum': ProductFeedRulePreviewSample.RuleType.__dict__.values(),
        }
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/rule_preview_samples',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=ProductFeedRulePreviewSample,
            api_type='EDGE',
            response_parser=ObjectParser(target_class=ProductFeedRulePreviewSample, api=self._api),
        )
        request.add_params(params)
        request.add_fields(fields)
