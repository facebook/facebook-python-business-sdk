...
class InstagramBusiness(
    ...
    def __init__(self, fbid=None, parent_id=None, api=None):
        self._isInstagramBusiness = True
        super(InstagramBusiness, self).__init__(fbid, parent_id, api)
    ...
    def get_instagram_users(self, fields=None, params=None, batch=None, pending=False):
