...
class PublisherBlockList(
    ...
    def get_auto_applied_ad_accounts(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.adaccount import AdAccount
        param_types = {
            'business_id': 'Object',
        }
        ...
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/auto_applied_ad_accounts',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
    ...
    def get_auto_applied_businesses(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.business import Business
        param_types = {
        }
        enums = {
        ...
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/auto_applied_businesses',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=Business,
            api_type='EDGE',
