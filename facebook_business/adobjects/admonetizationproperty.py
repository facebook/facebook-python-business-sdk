...
class AdMonetizationProperty(
    ...
    def get_ad_spaces(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
        }
        enums = {
        }
    ...
    def get_price_target_segments(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
            'template': 'bool',
        }
        enums = {
        ...
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            endpoint='/price_target_segments',
            api=self._api,
            param_checker=TypeChecker(param_types, enums),
            target_class=AbstractCrudObject,
            api_type='EDGE',
