...
class ProductCatalogItemsBatchPost(
    AbstractObject,
):

    def __init__(self, api=None):
        super(ProductCatalogItemsBatchPost, self).__init__()
        self._isProductCatalogItemsBatchPost = True
        self._api = api
    ...
    class RequestOrigin:
        bulk_item_editor = 'BULK_ITEM_EDITOR'
        storm = 'STORM'
    ...
    def _get_field_enum_info(cls):
        field_enum_info = {}
        field_enum_info['ItemSubType'] = ProductCatalogItemsBatchPost.ItemSubType.__dict__.values()
        field_enum_info['RequestOrigin'] = ProductCatalogItemsBatchPost.RequestOrigin.__dict__.values()
