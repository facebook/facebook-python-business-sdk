...
class Ad(
    ...
    def get_activity_logs(self, fields=None, params=None, batch=None, pending=False):
        from facebook_business.adobjects.adgroupactivity import AdgroupActivity
        param_types = {
        ...
        enums = {
            'changed_all_enum': AdgroupActivity.ChangedAll.__dict__.values(),
            'changed_any_enum': AdgroupActivity.ChangedAny.__dict__.values(),
        }
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
            ...
            api_type='EDGE',
            response_parser=ObjectParser(target_class=AdgroupActivity, api=self._api),
        )
        request.add_params(params)
        request.add_fields(fields)
    ...
    def delete_tracking_tag(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
        }
        enums = {
        }
    ...
    def create_tracking_tag(self, fields=None, params=None, batch=None, pending=False):
        param_types = {
            'url': 'string',
    ...
    def _get_field_enum_info(cls):
        ...
        field_enum_info['Restriction'] = Ad.Restriction.__dict__.values()
