...
class AdAccountLightAdsetsGet(
    AbstractObject,
):

    def __init__(self, api=None):
        super(AdAccountLightAdsetsGet, self).__init__()
        self._isAdAccountLightAdsetsGet = True
        self._api = api
    ...
    def _get_field_enum_info(cls):
        field_enum_info = {}
        field_enum_info['DatePreset'] = AdAccountLightAdsetsGet.DatePreset.__dict__.values()
