...
class ProductItemInsights(
    ...
    def __init__(self, fbid=None, parent_id=None, api=None):
        ...
        super(ProductItemInsights, self).__init__(fbid, parent_id, api)
    ...
    def _get_field_enum_info(cls):
        field_enum_info = {}
        field_enum_info['InsightsSources'] = ProductItemInsights.InsightsSources.__dict__.values()
