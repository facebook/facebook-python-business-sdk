...
class AdCampaignDeliveryStats(
    ...
    class BidRecommendationTimeRangeType:
    ...
    def _get_field_enum_info(cls):
        field_enum_info = {}
        field_enum_info['BidRecommendationTimeRangeType'] = AdCampaignDeliveryStats.BidRecommendationTimeRangeType.__dict__.values()
