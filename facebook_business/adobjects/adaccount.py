...
class AdAccount(
    ...
    def create_ad_set(self, fields=None, params=None, batch=None, success=None, failure=None, pending=False):
        ...
        enums = {
            'attribution_count_type_enum': [
                'ALL_CONVERSIONS',
                'FIRST_CONVERSION',
            ],
            'automatic_manual_state_enum': [
                'AUTOMATIC',
                'MANUAL',
                'UNSET',
            ],
            ...
            'regional_regulated_categories_enum': [
                '0',
                '1',
                '2',
                '3',
    ...
    def get_recommendations(self, fields=None, params=None, batch=None, success=None, failure=None, pending=False):
        ...
        enums = {
            'recommendation_names_enum': AdAccountRecommendations.RecommendationNames.__dict__.values(),
            'recommendation_stages_enum': AdAccountRecommendations.RecommendationStages.__dict__.values(),
        }
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
    ...
    def get_targeting_browse(self, fields=None, params=None, batch=None, success=None, failure=None, pending=False):
        ...
        enums = {
            ...
            'optimization_goal_enum': AdAccountTargetingUnified.OptimizationGoal.__dict__.values(),
